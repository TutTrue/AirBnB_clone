...
class FileStorage ():
    ...
    Cicle : <class 'BaseModel'> -> to_dict() -> <class 'dict'> -> JSON dump -> <class 'str'> 
    ...
    def reload(self):
        """
        Deserializes the JSON objects in file.json to a python dictionary format
        then pass it as a kwargs to BaseModel constructor to convert it 
